...
def test_invalid_if():
    assert_parse_first_error(invalid_if_paren_code, SyntaxError, "expected '('")
    assert_parse_first_error(invalid_if_brace_code, SyntaxError, "expected '{'")
...
def test_invalid_elif():
    assert_parse_first_error(invalid_elif_code, SyntaxError, "expected '{'")
...
def test_invalid_for_paren():
    assert_parse_first_error(invalid_for_paren_code, SyntaxError, "expected '('")
...
def test_invalid_with_brace():
    assert_parse_first_error(invalid_with_brace_code, SyntaxError, "expected '{'")
...
def test_invalid_try_brace():
    assert_parse_first_error(invalid_try_brace_code, SyntaxError, "expected '{'")
...
def test_invalid_except():
    assert_parse_first_error(invalid_except_paren_code, SyntaxError, "expected '{'")
    assert_parse_first_error(invalid_except_brace_code, SyntaxError, "expected '{'")
...
def test_invalid_class_def():
    assert_parse_first_error(invalid_class_code, SyntaxError, "expected '{'")
    assert_parse_first_error(invalid_class_sub_code, SyntaxError, "expected '{'")
