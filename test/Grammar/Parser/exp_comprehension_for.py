...
def test_comp_gen():
    ...
    assert_code_match_unparse(comp_gen_code)
...
def test_comp_list():
    ...
    assert_code_match_unparse(comp_list_code)
...
def test_comp_list_annotated():
    ...
    assert_code_match_unparse(comp_list_annotated_code)
...
def test_comp_set():
    ...
    assert_code_match_unparse(comp_set_code)
...
def test_comp_set_annotated():
    ...
    assert_code_match_unparse(comp_set_annotated_code)
...
def test_comp_dict():
    ...
    assert_code_match_unparse(comp_dict_code)
...
def test_comp_gen_noinline():
    ...
    assert_code_match_unparse(comp_gen_noinline_code)
...
def test_comp_list_noinline():
    ...
    assert_code_match_unparse(comp_list_noinline_code)
...
def test_comp_dict_noinline():
    ...
    assert_code_match_unparse(comp_dict_noinline_code)
